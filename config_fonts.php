...
// Leave undefined if not require_onced
...
// only works using subsets (otherwise would add very large file)
// Leave undefined or blank if not not require_onced
...
within the collection is require_onced. Fonts in the collection are numbered 
...
// but you do not require_once them. This allows a more efficient form of subsetting to be used.
$this->BMPonly = array(
	"dejavusanscondensed",
	"dejavusans",
